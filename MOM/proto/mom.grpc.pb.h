...
class MomService final {
 public:
  ...
  typedef WithAsyncMethod_GetBook<WithAsyncMethod_SearchBooks<WithAsyncMethod_RegisterUser<WithAsyncMethod_AuthenticateUser<WithAsyncMethod_GetUser<WithAsyncMethod_UpdateUser<WithAsyncMethod_CreateOrder<WithAsyncMethod_GetOrder<WithAsyncMethod_ListOrdersByUser<Service > > > > > > > > > AsyncService;
  template <class BaseClass>
  ...
  typedef WithCallbackMethod_GetBook<WithCallbackMethod_SearchBooks<WithCallbackMethod_RegisterUser<WithCallbackMethod_AuthenticateUser<WithCallbackMethod_GetUser<WithCallbackMethod_UpdateUser<WithCallbackMethod_CreateOrder<WithCallbackMethod_GetOrder<WithCallbackMethod_ListOrdersByUser<Service > > > > > > > > > CallbackService;
  ...
  typedef WithStreamedUnaryMethod_GetBook<WithStreamedUnaryMethod_SearchBooks<WithStreamedUnaryMethod_RegisterUser<WithStreamedUnaryMethod_AuthenticateUser<WithStreamedUnaryMethod_GetUser<WithStreamedUnaryMethod_UpdateUser<WithStreamedUnaryMethod_CreateOrder<WithStreamedUnaryMethod_GetOrder<WithStreamedUnaryMethod_ListOrdersByUser<Service > > > > > > > > > StreamedUnaryService;
  typedef Service SplitStreamedService;
  typedef WithStreamedUnaryMethod_GetBook<WithStreamedUnaryMethod_SearchBooks<WithStreamedUnaryMethod_RegisterUser<WithStreamedUnaryMethod_AuthenticateUser<WithStreamedUnaryMethod_GetUser<WithStreamedUnaryMethod_UpdateUser<WithStreamedUnaryMethod_CreateOrder<WithStreamedUnaryMethod_GetOrder<WithStreamedUnaryMethod_ListOrdersByUser<Service > > > > > > > > > StreamedService;
};
