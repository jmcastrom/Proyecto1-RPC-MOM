...
const (
	OrdersService_ListOrdersByUser_FullMethodName = "/orders.OrdersService/ListOrdersByUser"
)
...
func (c *ordersServiceClient) ListOrdersByUser(ctx context.Context, in *ListOrdersRequest, opts ...grpc.CallOption) (*ListOrdersResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(ListOrdersResponse)
	err := c.cc.Invoke(ctx, OrdersService_ListOrdersByUser_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedOrdersServiceServer) ListOrdersByUser(context.Context, *ListOrdersRequest) (*ListOrdersResponse, error) {
...
func _OrdersService_ListOrdersByUser_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ListOrdersRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(OrdersServiceServer).ListOrdersByUser(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: OrdersService_ListOrdersByUser_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(OrdersServiceServer).ListOrdersByUser(ctx, req.(*ListOrdersRequest))
	}
	...
	Methods: []grpc.MethodDesc{
		{
			...
			Handler:    _OrdersService_ListOrdersByUser_Handler,
		},
	},
	Streams:  []grpc.StreamDesc{},
	Metadata: "users/proto/orders_client.proto",
}
