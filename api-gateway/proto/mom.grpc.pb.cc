...
MomService::Stub::Stub(const std::shared_ptr< ::grpc::ChannelInterface>& channel, const ::grpc::StubOptions& options)
  ...
  , rpcmethod_UpdateStock_(MomService_method_names[2], options.suffix_for_stats(),::grpc::internal::RpcMethod::NORMAL_RPC, channel)
  , rpcmethod_RegisterUser_(MomService_method_names[3], options.suffix_for_stats(),::grpc::internal::RpcMethod::NORMAL_RPC, channel)
  , rpcmethod_AuthenticateUser_(MomService_method_names[4], options.suffix_for_stats(),::grpc::internal::RpcMethod::NORMAL_RPC, channel)
  , rpcmethod_GetUser_(MomService_method_names[5], options.suffix_for_stats(),::grpc::internal::RpcMethod::NORMAL_RPC, channel)
  , rpcmethod_UpdateUser_(MomService_method_names[6], options.suffix_for_stats(),::grpc::internal::RpcMethod::NORMAL_RPC, channel)
  , rpcmethod_CreateOrder_(MomService_method_names[7], options.suffix_for_stats(),::grpc::internal::RpcMethod::NORMAL_RPC, channel)
  , rpcmethod_GetOrder_(MomService_method_names[8], options.suffix_for_stats(),::grpc::internal::RpcMethod::NORMAL_RPC, channel)
  , rpcmethod_ListOrdersByUser_(MomService_method_names[9], options.suffix_for_stats(),::grpc::internal::RpcMethod::NORMAL_RPC, channel)
  {}
...
::grpc::Status MomService::Stub::UpdateStock(::grpc::ClientContext* context, const ::mom::UpdateStockRequest& request, ::mom::UpdateStockResponse* response) {
  return ::grpc::internal::BlockingUnaryCall< ::mom::UpdateStockRequest, ::mom::UpdateStockResponse, ::grpc::protobuf::MessageLite, ::grpc::protobuf::MessageLite>(channel_.get(), rpcmethod_UpdateStock_, context, request, response);
}

void MomService::Stub::async::UpdateStock(::grpc::ClientContext* context, const ::mom::UpdateStockRequest* request, ::mom::UpdateStockResponse* response, std::function<void(::grpc::Status)> f) {
  ::grpc::internal::CallbackUnaryCall< ::mom::UpdateStockRequest, ::mom::UpdateStockResponse, ::grpc::protobuf::MessageLite, ::grpc::protobuf::MessageLite>(stub_->channel_.get(), stub_->rpcmethod_UpdateStock_, context, request, response, std::move(f));
}

void MomService::Stub::async::UpdateStock(::grpc::ClientContext* context, const ::mom::UpdateStockRequest* request, ::mom::UpdateStockResponse* response, ::grpc::ClientUnaryReactor* reactor) {
...
::grpc::ClientAsyncResponseReader< ::mom::UpdateStockResponse>* MomService::Stub::PrepareAsyncUpdateStockRaw(::grpc::ClientContext* context, const ::mom::UpdateStockRequest& request, ::grpc::CompletionQueue* cq) {
  return ::grpc::internal::ClientAsyncResponseReaderHelper::Create< ::mom::UpdateStockResponse, ::mom::UpdateStockRequest, ::grpc::protobuf::MessageLite, ::grpc::protobuf::MessageLite>(channel_.get(), cq, rpcmethod_UpdateStock_, context, request);
}

::grpc::ClientAsyncResponseReader< ::mom::UpdateStockResponse>* MomService::Stub::AsyncUpdateStockRaw(::grpc::ClientContext* context, const ::mom::UpdateStockRequest& request, ::grpc::CompletionQueue* cq) {
  auto* result =
...
MomService::Service::Service() {
  ...
  AddMethod(new ::grpc::internal::RpcServiceMethod(
      ...
      ::grpc::internal::RpcMethod::NORMAL_RPC,
      new ::grpc::internal::RpcMethodHandler< MomService::Service, ::mom::UpdateStockRequest, ::mom::UpdateStockResponse, ::grpc::protobuf::MessageLite, ::grpc::protobuf::MessageLite>(
          [](MomService::Service* service,
             ::grpc::ServerContext* ctx,
             const ::mom::UpdateStockRequest* req,
             ::mom::UpdateStockResponse* resp) {
...
::grpc::Status MomService::Service::UpdateStock(::grpc::ServerContext* context, const ::mom::UpdateStockRequest* request, ::mom::UpdateStockResponse* response) {
  (void) context;
  (void) request;
  (void) response;
  return ::grpc::Status(::grpc::StatusCode::UNIMPLEMENTED, "");
